        ...
        if (adata.ready_to_start)
        {
            ...
            if (type == "tap")
            {
                ...
                if (isPreviousObjectDestroyed)
                {
                    if (!adata.auto_play)
                    {
                        if (Input.GetKeyDown("j") || Input.GetKeyDown(KeyCode.Joystick1Button1))
                        {
                            if (timelag <= adata.perfect)
                            {
                                // p[tFNg
                                ////Debug.Log("Prefect");
                                Instantiate(adata.p, new UnityEngine.Vector3(10.1f, 0.2f, -11.9f), UnityEngine.Quaternion.Euler(68.85f, 0.0f, 0.0f));
                                ScoreManeger.combo++;
                            ...
                            else if (timelag <= adata.good)
                            {
                                // Obh
                                ////Debug.Log("Good");
                                Instantiate(adata.g, new UnityEngine.Vector3(10.16f, 0.2f, -11.9f), UnityEngine.Quaternion.Euler(68.85f, 0.0f, 0.0f));
                                ScoreManeger.combo++;
                            ...
                            else if (timelag <= adata.bad)
                            {
                                // obh
                                ////Debug.Log("Bad");
                                Instantiate(adata.b, new UnityEngine.Vector3(10.22f, 0.2f, -11.9f), UnityEngine.Quaternion.Euler(68.85f, 0.0f, 0.0f));
                        ...
                        if (game_time > arrsec + adata.miss)
                        {
                            // ~X
                            ////Debug.Log("Miss");
                            Instantiate(adata.m, new UnityEngine.Vector3(10.2f, 0.2f, -11.9f), UnityEngine.Quaternion.Euler(68.85f, 0.0f, 0.0f));
                            ScoreManeger.combo = 0;
                            ResultUI.Miss++;
                            adata.clicked_L3++;
                            destroy_gameobject();
            ...
            if (isLongNoteActive)
            {
                ...
                if (isPreviousObjectDestroyed)
                {
                    ...
                    if (!adata.auto_play)
                    {
                        if ((Input.GetKeyDown("j") || Input.GetKeyDown(KeyCode.Joystick1Button1)) && !long_click)
                        {
                            if (timelag <= adata.perfect)
                            {
                                // p[tFNg
