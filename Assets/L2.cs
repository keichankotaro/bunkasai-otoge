        ...
        if (adata.ready_to_start)
        {
            ...
            if (type == "tap")
            {
                ...
                if (isPreviousObjectDestroyed)
                {
                    if (!adata.auto_play)
                    {
                        if (Input.GetKeyDown("f") || Input.GetKeyDown(KeyCode.Joystick1Button3))
                        {
                            if (timelag <= adata.perfect)
                            {
                                // p[tFNg
                                ////Debug.Log("Prefect");
                                Instantiate(adata.p, new UnityEngine.Vector3(9.48f, 0.2f, -11.9f), UnityEngine.Quaternion.Euler(68.85f, 0.0f, 0.0f));
                                ScoreManeger.combo++;
                            ...
                            else if (timelag <= adata.good)
                            {
                                // Obh
                                ////Debug.Log("Good");
                                Instantiate(adata.g, new UnityEngine.Vector3(9.56f, 0.2f, -11.9f), UnityEngine.Quaternion.Euler(68.85f, 0.0f, 0.0f));
                                ScoreManeger.combo++;
                            ...
                            else if (timelag <= adata.bad)
                            {
                                // obh
                                ////Debug.Log("Bad");
                                Instantiate(adata.b, new UnityEngine.Vector3(9.599f, 0.2f, -11.9f), UnityEngine.Quaternion.Euler(68.85f, 0.0f, 0.0f));
                        ...
                        if (game_time > arrsec + adata.miss)
                        {
                            // ~X
                            ////Debug.Log("Miss");
                            Instantiate(adata.m, new UnityEngine.Vector3(9.59f, 0.2f, -11.9f), UnityEngine.Quaternion.Euler(68.85f, 0.0f, 0.0f));
                            ScoreManeger.combo = 0;
                            ResultUI.Miss++;
                            adata.clicked_L2++;
                            destroy_gameobject();
            ...
            if (isLongNoteActive)
            {
                ...
                if (isPreviousObjectDestroyed)
                {
                    if (long_click && (game_time >= arrsec))
                    {
                        if (!adata.auto_play)
                        {
                            if (Input.GetKey("f") || Input.GetKey(KeyCode.Joystick1Button3))
                            {
                                long_click = true;
                                if (game_time >= endsec)
                                {
                    ...
                    if (!adata.auto_play)
                    {
                        if ((Input.GetKeyDown("f") || Input.GetKeyDown(KeyCode.Joystick1Button3)) && !long_click)
                        {
                            if (timelag <= adata.perfect)
                            {
                                // p[tFNg
